      ...
      <footer className="footer  py-14 px-10 bg-gray-800 dark:bg-gray-900 text-base-content">
        <aside>
          ...
          {/* <p className="-mt-3 ps-3.5 text-sm font-semibold text-slate-300 dark:text-white">
            Nuwan Siriwardhana <br/> Photography
          </p> */}
        ...
        <nav>
          ...
          <div className="flex flex-col space-y-3 text-base text-white">
            <a href="#home" className="link link-hover hover:text-amber-500">Home</a>
            <a href="#about"className="link link-hover hover:text-amber-500">
              About Us
            </a>
            <a href="#photography" className="link link-hover hover:text-amber-500">
              Photography
            </a>
            <a href="#contactus" className="link link-hover hover:text-amber-500">
              Contact Us
            </a>
          </div>
        </nav>
